...
5. Potential string truncation (`STRING_LENGTH_EXCEEDED`, WARNING)
6. Numeric precision overflow risk (`NUMERIC_PRECISION_EXCEEDED`, WARNING)
7. Numeric scale overflow risk (`NUMERIC_SCALE_EXCEEDED`, WARNING)
